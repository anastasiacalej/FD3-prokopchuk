...
test('работа кнопки "Редактировать"', () => {
  ...
  const component = renderer.create(
    ...
    //иначе ложное значение - для проверки кнопки 'Редактировать':
    editClient={null}
  ...
  // найдём в вёрстке компонента саму кнопку "Редактировать"
  const buttonElem = component.root.find(el => el.type=='input' && el.props.value == "Редактировать"); 
